...
def _migrate(conn):
    ...
    # The Opportunities feature, removed. Keyword search turned out to dilute
    # what this product is — finding what broke out in groups you follow — and
    # it never worked well enough to earn the confusion.
    #
    # Dropped rather than left orphaned, so the schema says what the product
    # does. The daily backup on the persistent disk still contains the table
